...
import 'package:tpk_login_arsa_01/page/10AnalysisPage/data/AnalysisPage_event.dart';
...
class TableJobListItem extends StatefulWidget {
  const TableJobListItem();

  @override
  _TableJobListItemState createState() => _TableJobListItemState();
}

class _TableJobListItemState extends State<TableJobListItem>
      ...
      children: [
        PaginatedDataTable(
          ...
          columns: [
            ...
            DataColumn(
              label: Text('REMARK NO',
                  style: styleDataColumn, textAlign: TextAlign.center),
              numeric: false,
              tooltip: 'RUNNING NUMBER',
              onSort: (columnIndex, ascending) =>
                  sort<String>((d) => d.remarkNo, columnIndex, ascending),
            ),
            DataColumn(
              label: Text('JOB TYPE',
                  style: styleDataColumn, textAlign: TextAlign.center),
    ...
    CoolAlert.show(
      ...
      onConfirmBtnTap: () {
        context
            ...
            .add(AnalysisPageEvent.returnItem);
  ...
  DataRow getRow(int index) {
    ...
    return DataRow.byIndex(
      ...
      onSelectChanged: (value) async {
        ...
        prefs.setString('InputAnalysisDataPage_InstrumentName',
            dataBuff.instrumentName.toString());
        BlocProvider.of<SwPageCubit>(context)
            .togglePage("InputAnalysisDataPage");
        dataItemSelected.clear();
        dataItemSelected.add(dataBuff);
        context
            .read<ManageDataAnalysisPage>()
            .add(AnalysisPageEvent.selectInstrument);
      ...
      cells: [
        ...
        DataCell(Container(
            ...
            child: Text(dataBuff.itemName.toString(),
                style: styleDataRow, textAlign: TextAlign.start))),
        DataCell(Container(
            child: Text(dataBuff.remarkNo.toString(),
                style: styleDataRow, textAlign: TextAlign.start))),
        DataCell(Container(
            //width: 150,
        ...
        DataCell(Container(
            ...
            child: Text(dataBuff.custFull.toString(),
                style: styleDataRow, textAlign: TextAlign.start))),
        DataCell(Container(
            child: Text(toDateOnly(dataBuff.samplingDate),
                style: styleDataRow, textAlign: TextAlign.start))),
        ...
        DataCell(
          IconButton(
            ...
            onPressed: () {
              itemReturnData.clear();
              itemReturnData.add(dataBuff);
              returnItem();
            },
          ),
        ),
