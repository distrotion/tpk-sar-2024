...
import 'package:tpk_login_arsa_01/page/8ListJobPage/Data/ListJobPage_event.dart';

class TableListJob extends StatefulWidget {
  const TableListJob();

  @override
  _TableListJobState createState() => _TableListJobState();
}

class _TableListJobState extends State<TableListJob> with RestorationMixin {
  //edit
  ...
  void restoreState(RestorationBucket? oldBucket, bool initialRestore) {
    ...
    switch (_sortColumnIndex.value) {
      ...
      case 1:
        ...
        break;
      case 2:
        _dataSource.sort<String>((d) => d.itemNo, _sortAscending.value);
        break;
      case 3:
      ...
      case 5:
        ...
        break;
      case 6:
        _dataSource.sort<int>((d) => d.sampleCode, _sortAscending.value);
        break;
      case 7:
      ...
      case 8:
        ...
        break;
      case 9:
        _dataSource.sort<String>((d) => d.errorName, _sortAscending.value);
        break; */
    }
  ...
  void sort<T>(
    Comparable<T> Function(ModelTableListJob d) getField,
    int columnIndex,
    bool ascending,
  ) {
  ...
  void manageData() {
    itemListJob.clear();
    for (int i = 0; i < _dataSource.dataSource.length; i++) {
      if (_dataSource.dataSource[i].selected == true) {
        itemListJob.add(_dataSource.dataSource[i]);
/*         print(_dataSource.dataSource[i].selected);
        print(i); */
      }
    }
    //print(modelTableListJobToJson(itemListJob));
  }
        ...
        PaginatedDataTable(
          ...
          actions: [
            InkWell(
              ...
              onTap: () {
                //print(modelTableListJobToJson(_dataSource.dataSource));
                //print(_dataSelections._dataSelections);//index selected
                //print("1 : ${_dataSource.dataSource.length}");
                manageData();
                context
                    .read<ManageDataListJob>()
                    .add(ListJobEvent.createListitem);
                context.read<ManageDataListJob>().add(ListJobEvent.clearState);
                context
                    .read<ManageDataListJob>()
...
class TableDataSource extends DataTableSource {
  ...
  late List<ModelTableListJob> dataSource;
  ...
  TableDataSource(this.context) {
    dataSource = dataTableListJob;
  }

  void sort<T>(
      Comparable<T> Function(ModelTableListJob d) getField, bool ascending) {
    dataSource.sort((a, b) {
      ...
      cells: [
        ...
        DataCell(Container(
            ...
            child: Text(dataBuff.custShort.toString(),
                style: styleDataRow, textAlign: TextAlign.start))),
        DataCell(Container(
            child: Text(dataBuff.itemNo.toString(),
                style: styleDataRow, textAlign: TextAlign.start))),
        DataCell(Container(
        ...
        DataCell(Container(
            child: Text(dataBuff.samplingDate.toString(),
                style: styleDataRow, textAlign: TextAlign.start))),
        /* DataCell(Container(
            child: statusItem(dataBuff.itemStatus))), */
        DataCell(Container(
...
class RestorableDataSelections extends RestorableProperty<Set<int>> {
  ...
  /// into a [Set].
  void setDataSelections(List<ModelTableListJob> dataIn) {
