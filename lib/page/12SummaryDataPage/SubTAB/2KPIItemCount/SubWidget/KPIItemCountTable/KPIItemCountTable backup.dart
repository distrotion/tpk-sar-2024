...
class _TableKPIItemCountState extends State<TableKPIItemCount>
  ...
  void restoreState(RestorationBucket? oldBucket, bool initialRestore) {
    ...
    switch (_sortColumnIndex.value) {
      case 0:
        ...
        break;
      case 1:
        _dataSource.sort<String>((d) => d.allCount, _sortAscending.value);
        break;
      case 2:
        _dataSource.sort<String>((d) => d.overDueCount, _sortAscending.value);
        break;
      case 3:
        _dataSource.sort<String>((d) => d.bPCount, _sortAscending.value);
        break;
      case 4:
        _dataSource.sort<String>((d) => d.bPOverDueCount, _sortAscending.value);
        break;
      case 5:
        _dataSource.sort<String>((d) => d.rYCount, _sortAscending.value);
        break;
      case 6:
        _dataSource.sort<String>((d) => d.rYOverDueCount, _sortAscending.value);
        break;
      case 7:
        _dataSource.sort<String>(
            (d) => d.errorInstrument, _sortAscending.value);
        break;
    }
  ...
  void sort<T>(
    Comparable<T> Function(ModelKPIItemData d) getField,
    int columnIndex,
    bool ascending,
  ) {
        ...
        PaginatedDataTable(
          ...
          columns: [
            ...
            DataColumn(
              ...
              numeric: false,
              onSort: (columnIndex, ascending) =>
                  sort<String>((d) => d.allCount, columnIndex, ascending),
            ),
            DataColumn(
              ...
              numeric: false,
              onSort: (columnIndex, ascending) =>
                  sort<String>((d) => d.overDueCount, columnIndex, ascending),
            ),
            DataColumn(
              label: Text('BP COUNT',
                  style: styleDataColumn, textAlign: TextAlign.center),
              numeric: false,
              onSort: (columnIndex, ascending) =>
                  sort<String>((d) => d.bPCount, columnIndex, ascending),
            ),
            DataColumn(
              label: Text('BP OVERDUE',
                  style: styleDataColumn, textAlign: TextAlign.center),
              numeric: false,
              onSort: (columnIndex, ascending) =>
                  sort<String>((d) => d.bPOverDueCount, columnIndex, ascending),
            ),
            DataColumn(
              label: Text('RY COUNT',
                  style: styleDataColumn, textAlign: TextAlign.center),
              numeric: false,
              onSort: (columnIndex, ascending) =>
                  sort<String>((d) => d.rYCount, columnIndex, ascending),
            ),
            DataColumn(
              label: Text('RY OVERDUE',
                  style: styleDataColumn, textAlign: TextAlign.center),
              numeric: false,
              onSort: (columnIndex, ascending) =>
                  sort<String>((d) => d.rYOverDueCount, columnIndex, ascending),
            ),
            DataColumn(
              label: Text('INSTRUMENT ERROR',
                  style: styleDataColumn, textAlign: TextAlign.center),
              numeric: false,
              onSort: (columnIndex, ascending) => sort<String>(
                  (d) => d.errorInstrument, columnIndex, ascending),
            ),
          ],
        ),
      ],
...
class TableDataSource extends DataTableSource {
  ...
  late List<ModelKPIItemData> dataSource;
  ...
  TableDataSource(this.context) {
    dataSource = dataTableKPIItem;
  }

  void sort<T>(
      Comparable<T> Function(ModelKPIItemData d) getField, bool ascending) {
    dataSource.sort((a, b) {
  ...
  DataRow getRow(int index) {
    ...
    return DataRow.byIndex(
      ...
      cells: [
        ...
        DataCell(Container(
            width: 100,
            child: Text(dataBuff.allCount.toString(),
                style: styleDataRow, textAlign: TextAlign.start))),
        DataCell(Container(
            width: 100,
            child: Text(dataBuff.overDueCount.toString(),
                style: styleDataRow, textAlign: TextAlign.start))),
        DataCell(Container(
            child: Text(dataBuff.bPCount.toString(),
                style: styleDataRow, textAlign: TextAlign.start))),
        DataCell(Container(
            //width: 150,
            child: Text(dataBuff.bPOverDueCount.toString(),
                style: styleDataRow, textAlign: TextAlign.start))),
        DataCell(Container(
            width: 150,
            child: Text(dataBuff.rYCount.toString(),
                style: styleDataRow, textAlign: TextAlign.start))),
        DataCell(Container(
            child: Text(dataBuff.rYOverDueCount.toString(),
                style: styleDataRow, textAlign: TextAlign.start))),
        DataCell(Container(
            child: Text(dataBuff.errorInstrument.toString(),
                style: styleDataRow, textAlign: TextAlign.start))),
      ],
    );
  }
...
class RestorableDataSelections extends RestorableProperty<Set<int>> {
  ...
  /// into a [Set].
  void setDataSelections(List<ModelKPIItemData> dataIn) {
