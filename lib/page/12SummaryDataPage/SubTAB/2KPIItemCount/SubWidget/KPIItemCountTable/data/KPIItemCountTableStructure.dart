...
List<SearchItemKPIModel> SearchItemKPIModelFromJson(String str) =>
    List<SearchItemKPIModel>.from(
        json.decode(str).map((x) => SearchItemKPIModel.fromJson(x)));

String SearchItemKPIModelToJson(List<SearchItemKPIModel> data) =>
    json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class SearchItemKPIModel {
  SearchItemKPIModel({
    this.requestNo = "",
    this.customerName = "",
    this.incharge = "",
  ...
  factory SearchItemKPIModel.fromJson(Map<String, dynamic> json) =>
      SearchItemKPIModel(
...
List<ModelKPIItemData> modelKPIItemDataFromJson(String str) =>
    List<ModelKPIItemData>.from(
        json.decode(str).map((x) => ModelKPIItemData.fromJson(x)));

String modelKPIItemDataToJson(List<MasterCustomerRoutine> data) =>
    json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class ModelKPIItemData {
  ModelKPIItemData({
    this.instrumentName,
    this.custFull,
    this.allCount,
  ...
  factory ModelKPIItemData.fromJson(Map<String, dynamic> json) =>
      ModelKPIItemData(
        instrumentName: json["instrumentName"] ?? "",
        custFull: json["custFull"] ?? "",
