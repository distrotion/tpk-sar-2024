                ...
                (index) => DataRow(cells: [
                      ...
                      DataCell(
                        Container(
                            width: widthC1,
                            child: Text(
                              dataTableKPIItem[index].branch.toString(),
                      ...
                      DataCell(
                        Container(
                            width: widthC4,
                            child: Text(
                              dataTableKPIItem[index].mKTCount.toString(),
                              textAlign: TextAlign.center,
                            )),
                      ),
                      DataCell(_verticalDivider),
                      ...
                      DataCell(
                        Container(
                            width: widthC6,
                            child: Text(
                              dataTableKPIItem[index].gASCount.toString(),
                              textAlign: TextAlign.center,
                            )),
                      ),
                      DataCell(_verticalDivider),
                      ...
                      DataCell(
                        Container(
                            width: widthC6,
                            child: Text(
                              dataTableKPIItem[index].iSNCount.toString(),
                              textAlign: TextAlign.center,
                            )),
                      ),
                      DataCell(_verticalDivider),
                      ...
                      DataCell(
                        Container(
                            width: widthC6,
                            child: Text(
                              dataTableKPIItem[index].kANCount.toString(),
                              textAlign: TextAlign.center,
                            )),
                      ),
                      DataCell(_verticalDivider),
