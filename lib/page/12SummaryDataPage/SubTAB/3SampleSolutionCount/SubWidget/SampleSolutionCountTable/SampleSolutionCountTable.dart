...
class SampleSolutionCountTable extends StatefulWidget {
  SampleSolutionCountTable({
    Key? key,
  }) : super(key: key);

  @override
  _SampleSolutionCountTableState createState() =>
      _SampleSolutionCountTableState();
}

class _SampleSolutionCountTableState extends State<SampleSolutionCountTable> {
  void initState() {
    print("InINITIAL SampleSolutionCountTable");
      ...
      children: [
        DataTable(
            ...
            rows: List<DataRow>.generate(
                dataTableSolutionCount.length,
                (index) => DataRow(cells: [
                      DataCell(
                        Container(
                            width: widthC1,
                            child: Text(
                              dataTableSolutionCount[index]
                                  .sampleType
                                  .toString(),
                            )),
                      ),
                      ...
                      DataCell(
                        Container(
                            width: widthC2,
                            child: Text(
                              dataTableSolutionCount[index].allCount.toString(),
                      ...
                      DataCell(
                        Container(
                            width: widthC4,
                            child: Text(
                              dataTableSolutionCount[index].bPCount.toString(),
                              textAlign: TextAlign.center,
                            )),
                      ),
                      /* 
                      ...
                      DataCell(
                        Container(
                            width: widthC6,
                            child: Text(
                              dataTableSolutionCount[index].rYCount.toString(),
                              textAlign: TextAlign.center,
                            )),
                      ), /* 
                      DataCell(_verticalDivider),
