...
List<SearchItemPerStaftModel> SearchItemPerStaftModelFromJson(String str) =>
    List<SearchItemPerStaftModel>.from(
        json.decode(str).map((x) => SearchItemPerStaftModel.fromJson(x)));

String SearchItemPerStaftModelToJson(List<SearchItemPerStaftModel> data) =>
    json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class SearchItemPerStaftModel {
  SearchItemPerStaftModel({
    this.requestNo = "",
    this.customerName = "",
    this.incharge = "",
  ...
  factory SearchItemPerStaftModel.fromJson(Map<String, dynamic> json) =>
      SearchItemPerStaftModel(
...
List<ItemPerStaftCountModel> ItemPerStaftCountModelFromJson(String str) =>
    List<ItemPerStaftCountModel>.from(
        json.decode(str).map((x) => ItemPerStaftCountModel.fromJson(x)));

String ItemPerStaftCountModelToJson(List<MasterCustomerRoutine> data) =>
    json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class ItemPerStaftCountModel {
  ItemPerStaftCountModel({
    this.name,
    this.instrumentName,
    this.custFull,
    this.allCount,
  ...
  factory ItemPerStaftCountModel.fromJson(Map<String, dynamic> json) =>
      ItemPerStaftCountModel(
        name: json["name"] ?? "",
        instrumentName: json["instrumentName"] ?? "",
        custFull: json["custFull"] ?? "",
