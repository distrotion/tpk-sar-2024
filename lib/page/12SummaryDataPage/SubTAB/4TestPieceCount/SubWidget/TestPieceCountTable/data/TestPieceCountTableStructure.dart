...
List<SearchTestPieceCountModel> SearchTestPieceCountModelFromJson(String str) =>
    List<SearchTestPieceCountModel>.from(
        json.decode(str).map((x) => SearchTestPieceCountModel.fromJson(x)));

String SearchTestPieceCountModelToJson(List<SearchTestPieceCountModel> data) =>
    json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class SearchTestPieceCountModel {
  SearchTestPieceCountModel({
    this.requestNo = "",
    this.customerName = "",
    this.incharge = "",
  ...
  factory SearchTestPieceCountModel.fromJson(Map<String, dynamic> json) =>
      SearchTestPieceCountModel(
...
List<TestPieceCountModel> TestPieceCountModelFromJson(String str) =>
    List<TestPieceCountModel>.from(
        json.decode(str).map((x) => TestPieceCountModel.fromJson(x)));

String TestPieceCountModelToJson(List<MasterCustomerRoutine> data) =>
    json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class TestPieceCountModel {
  TestPieceCountModel({
    this.sampleType,
    this.custFull,
    this.allCount,
  ...
  factory TestPieceCountModel.fromJson(Map<String, dynamic> json) =>
      TestPieceCountModel(
