...
import 'package:tpk_login_arsa_01/page/12SummaryDataPage/SubTAB/5RequestCount/SubWidget/RequestCountTable/RequestCountTable.dart';
import 'package:tpk_login_arsa_01/page/12SummaryDataPage/SubTAB/5RequestCount/SubWidget/RequestCountTable/data/RequestCountTableStructure.dart';
import 'package:tpk_login_arsa_01/page/12SummaryDataPage/SubTAB/5RequestCount/SubWidget/RequestCountTable/data/RequestCountTable_bloc.dart';
import 'package:tpk_login_arsa_01/page/12SummaryDataPage/SubTAB/5RequestCount/SubWidget/RequestCountTable/data/RequestCountTable_event.dart';

late BuildContext RequestCountContext;
...
class RequestCount extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        BlocProvider<ManageDataRequestCount>(
          create: (BuildContext context) => ManageDataRequestCount(),
        ),
      ],
      child: SingleChildScrollView(
        child: Container(
          margin: EdgeInsets.only(left: 50, right: 50, top: 20),
          child: RequestCountWidget(),
        ),
      ),
    );
  }
...
class RequestCountWidget extends StatefulWidget {
  const RequestCountWidget({Key? key}) : super(key: key);

  @override
  _RequestCountWidgetState createState() => _RequestCountWidgetState();
}

class _RequestCountWidgetState extends State<RequestCountWidget> {
  void initState() {
    print("InINITIAL");
    super.initState();
  }
    ...
    return Form(
      ...
      child: Column(
        ...
        children: [
          ...
          BlocBuilder<ManageDataRequestCount, int>(builder: (context, state) {
            print("RequestCountWidget rebuild state :$state");
            if (state >= 0 && state < 3)
              return Column(
                children: [
                  SizedBox(
...
class _SearchBarState extends State<SearchBar> {
  ...
  void clearSearch() {
    print('inclear');
    searchOption.clear();
    searchOption.add(SearchRequestCountModel());
                          ...
                          children: [
                            Container(
                              ...
                              child: IconButton(
                                ...
                                onPressed: () {
                                  context
                                      .read<ManageDataRequestCount>()
                                      .add(RequestCountEvent.clearAndSearch);
                                },
                              ),
                            ),
                            Container(
