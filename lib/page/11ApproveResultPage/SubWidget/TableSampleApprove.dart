...
List<ModelFullRequestData> dataTableSampleApprove = [];
Future<SharedPreferences> _prefs = SharedPreferences.getInstance();

class TableSampleApprove extends StatefulWidget {
  const TableSampleApprove();

  @override
  _TableSampleApproveState createState() => _TableSampleApproveState();
}

class _TableSampleApproveState extends State<TableSampleApprove>
        ...
        PaginatedDataTable(
          ...
          actions: [
            /* InkWell(
                    ...
                    onTap: () => print(
                        ModelFullRequestDataToJson(dataTableSampleApprove))) */
          ],
          headingRowHeight: 30,
...
class TableDataSource extends DataTableSource {
  ...
  TableDataSource(this.context) {
    dataSource = dataTableSampleApprove;
  }
  ...
  DataRow getRow(int index) {
    ...
    return DataRow.byIndex(
      ...
      onSelectChanged: (value) async {
        ...
        prefs.setString('RoutineRequestDetailTTCPage_reqNo', dataBuff.reqNo);
        /* context
            .read<ManageDataListApproveResultPage>()
            .add(ListApproveResultPageEvent.clearState);   */
      ...
      cells: [
        ...
        DataCell(Container(
            child: Text(dataBuff.itemName.toString(),
                style: styleDataRow, textAlign: TextAlign.start))),
        DataCell(Container(
            child: Center(child: statusItem(dataBuff.itemStatus.toString(),12)))),
      ],
    );
  }
