...
List<ModelDensity_WAX> modelDensity_WAXFromJson(String str) =>
    List<ModelDensity_WAX>.from(
        json.decode(str).map((x) => ModelDensity_WAX.fromJson(x)));

String modelDensity_WAXToJson(List<ModelDensity_WAX> data) =>
    json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class ModelDensity_WAX {
  ModelDensity_WAX(
  ...
  factory ModelDensity_WAX.fromJson(Map<String, dynamic> json) =>
      ModelDensity_WAX(
