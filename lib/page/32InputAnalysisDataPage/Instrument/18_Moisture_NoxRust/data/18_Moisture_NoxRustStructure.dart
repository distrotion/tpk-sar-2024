...
List<ModelMoisture_NoxRust> modelMoisture_NoxRustFromJson(String str) =>
    List<ModelMoisture_NoxRust>.from(json.decode(str).map((x) => ModelMoisture_NoxRust.fromJson(x)));

String modelMoisture_NoxRustToJson(List<ModelMoisture_NoxRust> data) =>
    json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class ModelMoisture_NoxRust {
  ModelMoisture_NoxRust({
  ...
  factory ModelMoisture_NoxRust.fromJson(Map<String, dynamic> json) => ModelMoisture_NoxRust(
