...
List<ModelFlashPoint_WAX> modelFlashPoint_WAXFromJson(String str) =>
    List<ModelFlashPoint_WAX>.from(json.decode(str).map((x) => ModelFlashPoint_WAX.fromJson(x)));

String modelFlashPoint_WAXToJson(List<ModelFlashPoint_WAX> data) =>
    json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class ModelFlashPoint_WAX {
  ModelFlashPoint_WAX({
  ...
  factory ModelFlashPoint_WAX.fromJson(Map<String, dynamic> json) => ModelFlashPoint_WAX(
