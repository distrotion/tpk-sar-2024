...
List<ModelNV> modelNVFromJson(String str) =>
    List<ModelNV>.from(json.decode(str).map((x) => ModelNV.fromJson(x)));

String modelNVToJson(List<ModelNV> data) =>
...
class ModelNV {
  ...
  factory ModelNV.fromJson(Map<String, dynamic> json) => ModelNV(
