...
List<ModelDsmut> modelDsmutFromJson(String str) =>
    List<ModelDsmut>.from(json.decode(str).map((x) => ModelDsmut.fromJson(x)));

String modelDsmutToJson(List<ModelDsmut> data) =>
...
class ModelDsmut {
  ...
  factory ModelDsmut.fromJson(Map<String, dynamic> json) => ModelDsmut(
        ...
        canEdit: false,
        pos_1: json["Pos_1"] ?? "",
        blank_1: json["Blank_1"] ?? "",
        pos_2: json["Pos_2"] ?? "",
        blank_2: json["Blank_2"] ?? "",
      );
