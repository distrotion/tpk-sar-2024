...
List<ModelViscosity_WAX> modelViscosity_WAXFromJson(String str) =>
    List<ModelViscosity_WAX>.from(
        json.decode(str).map((x) => ModelViscosity_WAX.fromJson(x)));

String modelViscosity_WAXToJson(List<ModelViscosity_WAX> data) =>
    json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class ModelViscosity_WAX {
  ModelViscosity_WAX(
  ...
  factory ModelViscosity_WAX.fromJson(Map<String, dynamic> json) =>
      ModelViscosity_WAX(
