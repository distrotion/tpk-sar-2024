...
List<ModelXRD_020Ratio> modelXRD_020RatioFromJson(String str) =>
    List<ModelXRD_020Ratio>.from(
        json.decode(str).map((x) => ModelXRD_020Ratio.fromJson(x)));

String modelXRD_020RatioToJson(List<ModelXRD_020Ratio> data) =>
    json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class ModelXRD_020Ratio {
  ModelXRD_020Ratio({
  ...
  dynamic canEdit;
  dynamic p1Peak_1;
  dynamic p1Intensity_1;
  dynamic p2Peak_1;
  dynamic p2Intensity_1;
  dynamic p1Peak_2;
  dynamic p1Intensity_2;
  dynamic p2Peak_2;
  dynamic p2Intensity_2;

  factory ModelXRD_020Ratio.fromJson(Map<String, dynamic> json) =>
      ModelXRD_020Ratio(
        ...
        p1Peak_1: json["P1Peak_1"] ?? "",
        p1Intensity_1: json["P1Intensity_1"] ?? "",
        p2Intensity_1: json["P2Intensity_1"] ?? "",
        p2Peak_1: json["P2Peak_1"] ?? "",
        p1Peak_2: json["P1Peak_2"] ?? "",
        p1Intensity_2: json["P1Intensity_2"] ?? "",
        p2Intensity_2: json["P2Intensity_2"] ?? "",
        p2Peak_2: json["P2Peak_2"] ?? "",
        canEdit: false,
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "P1Intensity_1":p1Intensity_1 ?? "",
        "P1Peak_1":p1Peak_1 ?? "",
        "P2Intensity_1":p2Intensity_1 ?? "",
        "P2Peak_1":p2Peak_1 ?? "",
        "P1Intensity_2":p1Intensity_2 ?? "",
        "P1Peak_2":p1Peak_2 ?? "",
        "P2Intensity_2":p2Intensity_2 ?? "",
        "P2Peak_2":p2Peak_2 ?? "",
      };
}
