...
List<ModelCO32> modelCO32FromJson(String str) => List<ModelCO32>.from(
    json.decode(str).map((x) => ModelCO32.fromJson(x)));

String modelCO32ToJson(List<ModelCO32> data) =>
...
class ModelCO32 {
  ...
  factory ModelCO32.fromJson(Map<String, dynamic> json) => ModelCO32(
