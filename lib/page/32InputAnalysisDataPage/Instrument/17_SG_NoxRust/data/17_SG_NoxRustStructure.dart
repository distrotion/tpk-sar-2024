...
List<ModelSG_NoxRust> modelSG_NoxRustFromJson(String str) =>
    List<ModelSG_NoxRust>.from(json.decode(str).map((x) => ModelSG_NoxRust.fromJson(x)));

String modelSG_NoxRustToJson(List<ModelSG_NoxRust> data) =>
    json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class ModelSG_NoxRust {
  ModelSG_NoxRust({
  ...
  factory ModelSG_NoxRust.fromJson(Map<String, dynamic> json) => ModelSG_NoxRust(
