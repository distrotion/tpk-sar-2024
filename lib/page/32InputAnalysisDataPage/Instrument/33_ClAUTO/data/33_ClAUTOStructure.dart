...
List<ModelClAUTO> modelClAUTOFromJson(String str) => List<ModelClAUTO>.from(
    json.decode(str).map((x) => ModelClAUTO.fromJson(x)));

String modelClAUTOToJson(List<ModelClAUTO> data) =>
...
class ModelClAUTO {
  ...
  factory ModelClAUTO.fromJson(Map<String, dynamic> json) => ModelClAUTO(
