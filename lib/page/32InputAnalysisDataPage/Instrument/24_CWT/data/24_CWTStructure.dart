...
List<ModelCWT> modelCWTFromJson(String str) => List<ModelCWT>.from(
    json.decode(str).map((x) => ModelCWT.fromJson(x)));

String modelCWTToJson(List<ModelCWT> data) =>
...
class ModelCWT {
  ...
  factory ModelCWT.fromJson(Map<String, dynamic> json) => ModelCWT(
