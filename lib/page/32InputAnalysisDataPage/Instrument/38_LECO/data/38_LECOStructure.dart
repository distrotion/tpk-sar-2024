...
List<ModelLECO> modelLECOFromJson(String str) =>
    List<ModelLECO>.from(json.decode(str).map((x) => ModelLECO.fromJson(x)));

String modelLECOToJson(List<ModelLECO> data) =>
...
class ModelLECO {
  ...
  factory ModelLECO.fromJson(Map<String, dynamic> json) => ModelLECO(
