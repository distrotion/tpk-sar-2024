...
List<ModelLvalue> modelLvalueFromJson(String str) =>
    List<ModelLvalue>.from(json.decode(str).map((x) => ModelLvalue.fromJson(x)));

String modelLvalueToJson(List<ModelLvalue> data) =>
...
class ModelLvalue {
  ...
  factory ModelLvalue.fromJson(Map<String, dynamic> json) => ModelLvalue(
