...
List<ModelPH> modelPHFromJson(String str) =>
    List<ModelPH>.from(json.decode(str).map((x) => ModelPH.fromJson(x)));

String modelPHToJson(List<ModelPH> data) =>
...
class ModelPH {
  ...
  factory ModelPH.fromJson(Map<String, dynamic> json) => ModelPH(
