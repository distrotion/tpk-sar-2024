...
List<ModelFlashPoint_NoxRust> modelFlashPoint_NoxRustFromJson(String str) =>
    List<ModelFlashPoint_NoxRust>.from(json.decode(str).map((x) => ModelFlashPoint_NoxRust.fromJson(x)));

String modelFlashPoint_NoxRustToJson(List<ModelFlashPoint_NoxRust> data) =>
    json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class ModelFlashPoint_NoxRust {
  ModelFlashPoint_NoxRust({
  ...
  factory ModelFlashPoint_NoxRust.fromJson(Map<String, dynamic> json) => ModelFlashPoint_NoxRust(
