...
List<ModelBrix> modelBrixFromJson(String str) => List<ModelBrix>.from(
    json.decode(str).map((x) => ModelBrix.fromJson(x)));

String modelBrixToJson(List<ModelBrix> data) =>
...
class ModelBrix {
  ...
  factory ModelBrix.fromJson(Map<String, dynamic> json) => ModelBrix(
