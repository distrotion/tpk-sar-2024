...
List<ModelFilter> modelFilterFromJson(String str) =>
    List<ModelFilter>.from(json.decode(str).map((x) => ModelFilter.fromJson(x)));

String modelFilterToJson(List<ModelFilter> data) =>
