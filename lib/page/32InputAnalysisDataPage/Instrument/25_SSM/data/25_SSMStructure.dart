...
List<ModelSSM> modelSSMFromJson(String str) =>
    List<ModelSSM>.from(json.decode(str).map((x) => ModelSSM.fromJson(x)));

String modelSSMToJson(List<ModelSSM> data) =>
...
class ModelSSM {
  ...
  factory ModelSSM.fromJson(Map<String, dynamic> json) => ModelSSM(
