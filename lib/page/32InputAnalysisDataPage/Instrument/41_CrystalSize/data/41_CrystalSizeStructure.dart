...
List<ModelCrystalSize> modelCrystalSizeFromJson(String str) =>
    List<ModelCrystalSize>.from(
        json.decode(str).map((x) => ModelCrystalSize.fromJson(x)));

String modelCrystalSizeToJson(List<ModelCrystalSize> data) =>
    json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class ModelCrystalSize {
  ModelCrystalSize(
  ...
  factory ModelCrystalSize.fromJson(Map<String, dynamic> json) =>
      ModelCrystalSize(
