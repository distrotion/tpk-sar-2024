...
List<ModelNV_NoxRust> modelNV_NoxRustFromJson(String str) =>
    List<ModelNV_NoxRust>.from(
        json.decode(str).map((x) => ModelNV_NoxRust.fromJson(x)));

String modelNV_NoxRustToJson(List<ModelNV_NoxRust> data) =>
    json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class ModelNV_NoxRust {
  ModelNV_NoxRust({
  ...
  factory ModelNV_NoxRust.fromJson(Map<String, dynamic> json) =>
      ModelNV_NoxRust(
