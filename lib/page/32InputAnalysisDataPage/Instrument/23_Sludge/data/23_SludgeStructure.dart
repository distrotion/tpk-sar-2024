...
List<ModelSludge> modelSludgeFromJson(String str) => List<ModelSludge>.from(
    json.decode(str).map((x) => ModelSludge.fromJson(x)));

String modelSludgeToJson(List<ModelSludge> data) =>
...
class ModelSludge {
  ...
  factory ModelSludge.fromJson(Map<String, dynamic> json) => ModelSludge(
