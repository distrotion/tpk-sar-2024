...
List<ModelPULS> modelPULSFromJson(String str) => List<ModelPULS>.from(
    json.decode(str).map((x) => ModelPULS.fromJson(x)));

String modelPULSToJson(List<ModelPULS> data) =>
...
class ModelPULS {
  ...
  factory ModelPULS.fromJson(Map<String, dynamic> json) => ModelPULS(
