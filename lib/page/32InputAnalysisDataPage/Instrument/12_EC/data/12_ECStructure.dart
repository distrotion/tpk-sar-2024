...
List<ModelEC> modelECFromJson(String str) =>
    List<ModelEC>.from(json.decode(str).map((x) => ModelEC.fromJson(x)));

String modelECToJson(List<ModelEC> data) =>
...
class ModelEC {
  ...
  factory ModelEC.fromJson(Map<String, dynamic> json) => ModelEC(
