...
//
//     final modelTableRequestApprove = modelTableRequestApproveFromJson(jsondynamic);

import 'dart:convert';

import 'package:intl/intl.dart';

List<ModelTableResultDetail> modelTableRequestApproveFromJson(dynamic str) =>
    List<ModelTableResultDetail>.from(
        json.decode(str).map((x) => ModelTableResultDetail.fromJson(x)));

dynamic modelTableRequestApproveToJson(List<ModelTableResultDetail> data) =>
    json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class ModelTableResultDetail {
  ModelTableResultDetail({
    this.id,
    this.reqNo,
    this.jobType,
    this.branch,
  ...
  factory ModelTableResultDetail.fromJson(Map<dynamic, dynamic> json) =>
      ModelTableResultDetail(
        id: json["ID"] ?? "",
        reqNo: json["ReqNo"] ?? "",
