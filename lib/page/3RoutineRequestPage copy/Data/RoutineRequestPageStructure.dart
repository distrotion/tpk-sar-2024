...
class MasterCustomerRoutine {
  ...
  factory MasterCustomerRoutine.fromJson(Map<String, dynamic> json) =>
      MasterCustomerRoutine(
        ...
        frequencyRequest:
            json["Frequency"] == null ? null : json["FrequencyRequest"],
        incharge: json["Incharge"] == null ? null : json["Incharge"],
        subLeader: json["SubLeader"] == null ? null : json["SubLeader"],
        gl: json["GL"] == null ? null : json["GL"],
        jp: json["JP"] == null ? null : json["JP"],
        dmg: json["DMG"] == null ? null : json["DMG"],
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "SubLeader": subLeader == null ? null : subLeader,
        "GL": gl == null ? null : gl,
        "JP": jp == null ? null : jp,
        "DMG": dmg == null ? null : dmg,
      };
}
...
class MasterInstrument {
  ...
  factory MasterInstrument.fromJson(Map<String, dynamic> json) =>
      MasterInstrument(
        ...
        instrumentName: json["Instrument"] == null ? null : json["Instrument"],
  ...
  Map<String, dynamic> toJson() => {
        ...
        "Instrument": instrumentName == null ? null : instrumentName,
...
class AnalysisData {
  ...
  factory AnalysisData.fromJson(Map<String, dynamic> json) => AnalysisData(
        ...
        instrumentName: json["Instrument"],
        itemName: json["ItemName"] == null ? null : json["ItemName"],
        position: json["Position"],
        mag: json["Mag"],
        temp: json["Temp"],
        ...
        stdMin: json["StdMin"],
        requestRound :json["RequestRound"] == null ? null : json["RequestRound"],
      );
