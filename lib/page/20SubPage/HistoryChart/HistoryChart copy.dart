...
void showHistory(String _custFull, String _itemName, String _section,
...
class HistoryChartState extends State<HistoryChart> {
  ...
  Widget build(BuildContext context) {
    return FutureBuilder(
        future: searchHistoryChartData(widget.custFull, widget.itemName,
